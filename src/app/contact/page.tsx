...
export default function Contact(){
    return (
        <div className="w-full h-full overflow-x-hidden">
            <Header />
            {/** Mobile */}
            <div className="px-4 py-6 w-full mx-auto md:hidden">
              <div className="flex flex-col md:flex-row items-center">
                  <div className="w-full p-4 flex flex-row gap-2 justify-center">
                    <SocialButton
                      icon={faInstagram}
                      text=""
                  ...
                  <div className="py-2">
                    <div className="flex flex-row gap-2 items-center">
                      <FontAwesomeIcon icon={faLocationDot} className="text-2xl text-[#b8958d] w-6 h-6" />
                      <p className="text-xl text-[#b8958d]">
                        Situado em:
                      </p>
                    </div>
                    <div className="flex px-4">
                      <p className="text-base text-[#b8958d]">
            ...
            {/** Desktop */}
            <div className="px-4 py-6 max-w-screen-xl mx-auto hidden md:block">
